...
import { ErrorMessages, SmsPinverify } from "../../models";
import {
  useGetHistorySmsPinverify,
...
export default SmsPinverifyHistory;
...
function ItemHistory({ sms, activeNumbers }: PropsItemHistory) {
  const resend = useReuseSmsPinverify();
