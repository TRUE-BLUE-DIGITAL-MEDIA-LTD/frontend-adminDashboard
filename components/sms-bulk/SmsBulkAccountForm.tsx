...
import { useCreateSmsBulkAccount, useGetSmsBulkAccounts } from "../../react-query";

function SmsBulkAccountForm() {
  const create = useCreateSmsBulkAccount();
...
export default SmsBulkAccountForm;
